...
def test_get_total_collateral_value():
    ...
    client.mint_coin(a1.address, 300_000_000, auth_key_prefix=a1.auth_key_prefix, currency_code="vBTC")
    client.bank_lock(a1, 100_000_000, currency_code="vBTC")
...
def test_get_total_borrow_value():
    ...
    client.bank_lock(a1, 100_000_000, currency_code="vBTC")
    client.bank_borrow(a1, 10_000_000, currency_code="vBTC")
...
def test_redeem():
    ...
    client.bank_redeem(a1, amount=amount, currency_code="vBTC")
...
def test_borrow():
    ...
    client.bank_publish(a1, gas_currency_code="vBTC")
    client.bank_lock(a1, 100_000_000, currency_code="vBTC")
    client.bank_borrow(a1, 40_000_000, currency_code="vBTC")
...
def test_repay_borrow():
    ...
    client.mint_coin(a1.address, 300_000_000, auth_key_prefix=a1.auth_key_prefix, currency_code="vBTC")
    client.bank_publish(a1)
    client.bank_lock(a1, 200_000_000, currency_code="vBTC")
    client.bank_borrow(a1, 10_000_000, currency_code="vBTC")
    _, amount = client.bank_get_borrow_amount(a1.address, "vBTC")
    client.add_currency_to_account(a1, "VLS")
    client.bank_repay_borrow(a1, currency_code="vBTC", amount=amount)
...
def test_bank_get_supply_rate():
    ...
    client.bank_lock(a1, 100_000_000, currency_code="vBTC")
    client.bank_borrow(a1, 10_000_000, currency_code="vBTC")
    client.bank_lock(a2, 100_000_000, currency_code="vBTC")
    ...
    client.bank_redeem(a2, amount=lock_amount, currency_code="vBTC")
...
def test_bank_get_borrow_rate():
    ...
    client.bank_repay_borrow(a1, amount=borrow_amount, currency_code="vBTC")
...
def test_liquidate_borrow():
    ...
    client.bank_publish(a1, gas_currency_code="vBTC")
    client.bank_lock(a1, 100_000_000_000, currency_code="vBTC")
    client.bank_borrow(a1, 50_000_000_000-100, currency_code="vBTC")
...
def test_get_sum_incentive_amount():
    ...
    seq = client.bank_redeem(a1, 100_000_000, currency_code="vBTC")
