...
#test_initilaize()
#test_publish_reserve()
#test_add_liquidity()
#test_remove_liquidity()
test_swap()
#test_swap_get_liquidity_balances()
#test_swap_get_swap_output_amount()
#test_swap_get_swap_input_amount()
#test_swap_get_liquidity_output_amount()
#test_get_currency_max_output_path()
#test_get_currency_min_input_path()
