from libra_client.move_core_types.language_storage import StructTag
from libra_client.lbrtypes.access_path import AccessPath, Accesses
...
class MoveResource():
    ...
    def struct_tag(cls, *type_params, module_address=None):
        from libra_client.lbrtypes.account_config import CORE_CODE_ADDRESS
